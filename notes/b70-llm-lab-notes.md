...
- 3x B70 current fused Q4_0 stack with `GGML_SYCL_COMM_FUSEADD_ROOT_RESIDUAL=1`, 512 prompt / 512 output: `50.809 tok/s`, LocalMaxxing `cmouvurhh00nqld010dtr4xrl`.
...
3. Use 3x B70 Q4_0 at `50.809 tok/s` as the current best quality-preserving speed point; treat 4x Q4_0 as a profiling target until communication overhead is reduced.
