...
output and collapsed token diversity. It was not benchmarked or submitted to
LocalMaxxing. The temporary runtime patch was removed after the failed canary.
