...
LocalMaxxing accepted the first p512/n512 control run as `cmoz7rs2w0077tl01o3f1kxnm`, the second p512/n1024 control run as `cmoz82i2f007itl01fkno9or1`, and the second p512/n1536 control run as `cmoz8cow60001pd010klrb8g8`.
...
- Next validate larger `max_model_len` / `gpu_memory_utilization` settings to see whether the 41 tok/s behavior survives beyond the 2048-token request cap.
