...
Note: `cmoz1rowm004ztl01x4gt4y6d` is the longer-output validation for the FP16 llm-scaler u4 decode bridge. It keeps the same target weights and quality-preserving settings as the current FP16 high, with no speculative decode or power changes. At `p512/n1024` it reaches `35.933 tok/s` output, below the p512/n512 high of `37.136 tok/s`, which suggests the remaining ceiling includes active-context/KV decode cost rather than only prefill amortization.
