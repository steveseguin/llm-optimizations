...
- Current best MiniMax AutoRound valid speed result is FP16 p512/n1024 on the fast-NVMe vLLM/XPU TP4 path: `40.303730` output tok/s, after a same-shape `39.894083` repeat. The p512/n512 shape reached `39.610585` and repeated at `39.516373`. These keep normal Q/K TP allreduce, no speculative decode, and no power-limit change. LocalMaxxing accepted the p512/n1024 high as `cmoz82i2f007itl01fkno9or1`.
