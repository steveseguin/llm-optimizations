...
- Current best MiniMax AutoRound valid speed result is FP16 p512/n512 on the fast-NVMe vLLM/XPU TP4 path: `39.610585` output tok/s, repeated at `39.516373` output tok/s. It keeps normal Q/K TP allreduce, no speculative decode, and no power-limit change. LocalMaxxing accepted the first run as `cmoz7rs2w0077tl01o3f1kxnm`.
