...
- `notes/2026-05-10-minimax-xpu-ipc-qk-var-prototype.md`: PyTorch/SYCL Level Zero IPC Q/K variance prototype; two-phase peer mailbox reduce passes, and the device-counter sequence path now passes 4-rank slot-reuse stress.
