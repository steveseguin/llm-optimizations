...
- For 8192-context capacity, the same FP16 0.95 recipe completed p512/n1536 at `33.308012` output tok/s with 25,600 GPU KV-cache tokens and 3.12x max concurrency for 8192-token requests, accepted as `cmoz90lg0000wpd018x3zuukw`. This is a valid capacity datapoint, but not a speed path.
